...
#'  - Station names can have **multiple station IDs or names** (did they get re-numbered?)
#'  We collapse these into single IDs/names.
#'  - **Some station names are suffixed** with " (*)" or other patterns.  This suffix is removed.
#'
#' ## New variables added
#'
...
#'    exists, as opposed to a point. Meant as a convenient aggregating measure
#'    for later analysis.
...
#'    and pleasure cruises, and filter out trip distances of 0.
