...
p <- 
  ...
  labs(subtitle = "Red means a high percentage of casual users, as opposed to \nmembers. Larger circles mean more trips starting here.") 
p
  # ylim(c(41.77, 42.01)) +
  # xlim(c(-87.8, -87.57)) +
...
animate(plot = p, fps = 24, nframes = 432)
# anim_save("img/traffic_volume_map.gif", p, fps = 22, nframes = 288)
```

```{r}
anim_save("img/traffic_volume_anim2.mp4", p, fps = 24, nframes = 432, 
